...
export const BRANDS: Record<string, {
  ...
  'Burger Craft': {
    ...
    color: '#8b1a1a',
    items: [
      { name: 'Classic Cheese Burger',       prepSecs: 22 },
      { name: 'Chicken Double Patty Burger', prepSecs: 25 },
      { name: 'Veg Patty Burger',            prepSecs: 20 },
      { name: 'Paneer Fresh Burger',         prepSecs: 22 },
      { name: 'BBQ Bacon Smash Burger',       prepSecs: 25 },
      { name: 'Spicy Jalapeño Crispy Chicken',prepSecs: 24 },
      { name: 'Truffle Mushroom Swiss Burger',prepSecs: 25 },
      { name: 'Fiery Crispy Paneer Burger',   prepSecs: 22 },
      { name: 'Double Stack Cheeseburger',   prepSecs: 25 },
      { name: 'Mini Sliders Trio',           prepSecs: 20 },
    ],
  },
  'Grill House': {
    station: 'Grill',
    color: '#2d5a2d',
    items: [
      { name: 'Classic French Fries',        prepSecs: 20 },
      { name: 'Peri Peri Crinkle Fries',     prepSecs: 22 },
      { name: 'Loaded Cheese Fries',         prepSecs: 24 },
      { name: 'Grilled Chicken Wings (6pcs)',prepSecs: 30 },
      { name: 'Smoky BBQ Chicken Skewers',   prepSecs: 32 },
      { name: 'Grilled Paneer Tikka Bites',  prepSecs: 28 },
      { name: 'Garlic Herb Grilled Chicken', prepSecs: 34 },
      { name: 'Crispy Golden Onion Rings',   prepSecs: 20 },
      { name: 'Cheesy Loaded Potato Wedges', prepSecs: 24 },
      { name: 'Grilled Lamb Seekh Kebab',    prepSecs: 40 },
    ],
  },
  'Bowl & Salad Co.': {
    station: 'Assembly',
    color: '#1a4a6b',
    items: [
      { name: 'Brioche Burger Buns',        prepSecs: 20 },
      { name: 'Extra Spicy Mayo Modifier',  prepSecs: 20 },
      { name: 'Garlic Dip Portion',         prepSecs: 20 },
      { name: 'Greek Mediterranean Salad',  prepSecs: 22 },
      { name: 'Teriyaki Chicken Protein Bowl',prepSecs: 24 },
      { name: 'Mexican Burrito Power Bowl', prepSecs: 25 },
      { name: 'Chipotle Paneer Super Bowl', prepSecs: 22 },
      { name: 'Asian Sesame Tofu Bowl',     prepSecs: 22 },
      { name: 'Classic Caesar Salad Bowl',  prepSecs: 20 },
      { name: 'Creamy Ranch Dip Portion',   prepSecs: 20 },
    ],
  },
};
